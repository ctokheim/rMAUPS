#' Preprocess CPTAC data sets
#'
#' @docType methods
#' @name processCPTAC
#' @rdname processCPTAC
#'
#' @param exprSet Protein abundance data or Phosphorylation site abundance data.
#' @param selection Unshared or Shared.
...
#'
#'
processCPTAC <- function(exprSet, selection="Shared", type="protein"){
  # Protein abundance data
  if (type == "protein"){
    # Select the shared or unshared data
    if(tolower(selection) =="unshared"){
